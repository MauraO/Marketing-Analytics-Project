---
title: "Black Friday"
author: "Weicheng Zhang, Zilei Zhang, Maura Oray"
date: "9/24/2018"
...
In this project, we want to: (1)predict the age of the consumer and their targeted goods, (2)figure out the relationship between different categories of goods bought. This dataset is also particularly convenient for clustering and maybe (3)find different clusters of consumers within it.
...
##Clean and prepare data, change certain variables to factors

BF[3:11] <- lapply(BF[3:11], factor)
