...
+Gender,data=demo)#multiple linear regression 

lm_multiple=lm(log(Purchase)~Gender+Age+Occupation+City_Category+Stay_In_Current_City_Years+Marital_Status
+Gender*Marital_Status+City_Category*Stay_In_Current_City_Years+Occupation*City_Category,data=demo)#double check this one

summary(lm_multiple)
anova(lm_multiple)
```

Regression explanation: Gloria
